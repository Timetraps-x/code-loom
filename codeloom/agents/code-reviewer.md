...
- Host-provided attempt-scoped diff generated from attempt start snapshot to review snapshot.
...
6. Check likely correctness, security, maintainability, and regression risks, plus code-quality risks.
   ...
   - `attempt-changes.json` is a lightweight summary; use the host-provided scoped diff for code-level review.
